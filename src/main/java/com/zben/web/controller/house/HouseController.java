package com.zben.web.controller.house;

import com.zben.base.ApiResponse;
import com.zben.base.RentValueBlock;
import com.zben.dto.*;
...
import com.zben.service.user.IUserService;
...
public class HouseController {
    ...
    public ApiResponse getSupportCities() {
        ...
        if (result.getResultSize() == 0) {
            return ApiResponse.success(ApiResponse.Status.NOT_FOUND);
        }
    ...
    public ApiResponse getSupportRegions(@RequestParam(name = "city_name") String cityEnName) {
        ...
        return ApiResponse.success(addressResult.getResult());
    }
    ...
    public ApiResponse getSupportSubwayStation(@RequestParam(name = "subway_id") Long subwayId) {
        ...
        return ApiResponse.success(stationDTOS);
    }
